...
import { findAllBookByOwner } from '../fn/book/find-all-book-by-owner';
import { FindAllBookByOwner$Params } from '../fn/book/find-all-book-by-owner';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `findAllBookByOwner()` */
  static readonly FindAllBookByOwnerPath = '/books/owner';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `findAllBookByOwner()` instead.
   *
   * This method doesn't expect any request body.
   */
  findAllBookByOwner$Response(params?: FindAllBookByOwner$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseBookResponse>> {
    return findAllBookByOwner(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `findAllBookByOwner$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  findAllBookByOwner(params?: FindAllBookByOwner$Params, context?: HttpContext): Observable<PageResponseBookResponse> {
    return this.findAllBookByOwner$Response(params, context).pipe(
      map((r: StrictHttpResponse<PageResponseBookResponse>): PageResponseBookResponse => r.body)
    );
  }
